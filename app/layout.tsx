  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content="Welcome to Punyakrit's portfolio website. Explore my projects and skills." />
        ...
        <meta property="og:description" content="Welcome to Punyakrit's portfolio website. Explore my projects and skills." />
